...
leftVictor = new WPI_VictorSPX(0);
...
differentialDrive1 = new DifferentialDrive(leftVictor, rightVictor);
...
doubleSolenoid = new DoubleSolenoid(10, PneumaticsModuleType.CTREPCM, 0, 1);
